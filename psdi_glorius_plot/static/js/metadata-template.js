 ...
 */
export function makeMetadata(title, desc, timestamp, version, licenseName, licenseURL, authorInfo, bibInfo,
	reactionSchemePresent, baselineDescPresent, condDescPresent) {
    ...
    "@graph": [
		...
		}${reactionSchemeInfo}${baselineDescInfo}${condDescInfo}${bibInfo}${licenseInfo}
	]
}`;
